...
export const STATUS_COLORS: Record<string, string> = {
  ...
  '要求出货':  'bg-amber-100 text-amber-800',
  '已要求出货':'bg-orange-100 text-orange-800',
  '已收账单':  'bg-gray-200 text-gray-700',
  // legacy — kept for display of older records
  '已要求提货':'bg-orange-100 text-orange-800',
  '已确认':    'bg-orange-100 text-orange-800',
  '已填表':    'bg-orange-100 text-orange-800',
